...
module.exports = {
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          // dae is custom 3d print format used by CPD
          {
            test: [/\.bmp$/, /\.gif$/, /\.jpe?g$/, /\.png$/, /\.dae$/],
  ...
  plugins: [
    ...
    new BaseHrefWebpackPlugin({ baseHref: `${process.env.APP_URL}/index.html` }),
    ...
    new Dotenv({
      path: `./config/env/${process.env.BRANCH}.env`, // load this now instead of the ones in '.env'
